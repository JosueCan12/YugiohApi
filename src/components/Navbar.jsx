...
function Navbar() {
  return (
    <div className="">
      <nav className="bg-[#00a0b0] px-6 shadow-md fixed inset-x-0 top-0">
        <div className="flex flex-row justify-between items-center py-1">
          <h3 className="font-semibold text-3xl text-white pl-5">YUGIOH!</h3>
          <div className="group flex flex-col items-center">
            ...
            <div className="hidden group-hover:block md:block absolute md:static pr-10  inset-x-0 top-16 py-3 shadow-md md:shadow-none text-gray-600">
              <div className="flex flex-row justify-center items-center text-center font-semibold text-white">
                ...
                <Link
                  to="/perfil"
                  className="pr-8 py-1 flex flex-col md:flex-row md:items-center"
                >
                  <img
